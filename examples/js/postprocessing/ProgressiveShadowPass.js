function ProgressiveShadowPass( scene, camera ) {
  ...
  this.lightCamera = new THREE.PerspectiveCamera( 170, window.innerWidth / window.innerHeight, 1, 1000 );
  ...
  getShadowBufferAccumulationMaterial: function() {
    return new THREE.ShaderMaterial( {
      ...
      fragmentShader: "#include <packing>\
        ...
        \
        void main() {\
          float currentShadow = getShadow( shadowMap, shadowMapSize, -0.003, 2.0, shadowCoord);\
