THREE.WebGLProgram = ( function () {
	...
	function generateExtensions( extensions, parameters, rendererExtensions ) {
		...
		var chunks = [
			( extensions.derivatives || parameters.envMapCubeUV || parameters.bumpMap || parameters.normalMap || parameters.flatShading ) && renderer.Extensions.get( 'OES_standard_derivatives' ) ? '#extension GL_OES_standard_derivatives : enable' : '',
